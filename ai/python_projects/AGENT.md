...
- writing clean and understandable and high quality code is the priority, but make sure to write code that is reasonably efficient too - use the right data structures and algorithms for the task. If there is a critical code section, try to make if efficient.
